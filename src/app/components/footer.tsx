	...
	return (
		<footer className="w-full h-full container mx-auto mt-2">
			...
			<div className="flex flex-col gap-2 sm:flex-row sm:gap-0 w-full mx-auto py-5 px-4 items-center justify-between">
				<small className="text-xs sm:text-sm text-stone-500">{`© ${new Date().getFullYear()} SOLFS. All Rights Reserved.`}</small>
				<ul className="h-full w-full sm:w-fit flex flex-wrap text-stone-500 justify-center">
					...
					<li className="pr-2">
						<Link
							href="https://x.com/solfilesystem"
							target="_blank"
					...
					<li className="pr-2">
						<Link
							href="https://github.com/Solana-File-System/solfs"
							target="_blank"
							className="hover:text-violet-700 dark:hover:text-solana-purple/80 ease-in-out duration-200 focus:text-violet-700 dark:focus:text-solana-purple/80 focus:ring-0 appearance-none focus:outline-none"
						>
							<svg
					...
					<li className="pr-2">
						<Link
							href="https://www.linkedin.com/company/solanalabs/"
							target="_blank"
							className="hover:text-violet-700 dark:hover:text-solana-purple/80 ease-in-out duration-200 focus:text-violet-700 dark:focus:text-solana-purple/80 focus:ring-0 appearance-none focus:outline-none"
						>
							<svg
					...
					<li>
						<Link
							href="mailto:solanafilesystem@gmail.com"
							target="_blank"
							className="hover:text-violet-700 dark:hover:text-solana-purple/80 ease-in-out duration-200 focus:text-violet-700 dark:focus:text-solana-purple/80 focus:ring-0 appearance-none focus:outline-none"
						>
							<svg
